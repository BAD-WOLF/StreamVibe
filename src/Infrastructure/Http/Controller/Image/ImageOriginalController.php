...
/**
 * Controller for original image operations
 *
 ...
 */
#[AsController]
class ImageOriginalController extends AbstractController
{
    ...
    #[
        Route(
            name: "api_images_original",
            defaults: [
                "_api_resource_class" => ImageEntryPoint::class,
                "_api_operation_name" => "get_original_image",
            ],
            methods: ["GET"],
        ),
    ]
    public function __invoke(string $endpoint, Request $request): Response
    {
        if (empty($endpoint)) {
        ...
        try {
                ...
                return $this->json(
                    [
                        ...
                        "error" => $this->translator->trans(
                            "An error occurred while processing the original image",
                        ),
            ...
            return new Response(
                "Original image not found or processing error",
                404,
                [
