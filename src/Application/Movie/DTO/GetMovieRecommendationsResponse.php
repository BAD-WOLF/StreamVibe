...
/**
 * Response DTO for movie recommendations operations
 *
 * This DTO represents the response from getting movie recommendations.
 * It will be automatically mapped to ApiPlatform Output Models via the auto-mapping system.
 */
final class GetMovieRecommendationsResponse
{
