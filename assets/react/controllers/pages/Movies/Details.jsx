    ...
    <>
     <Header/>
      ...
      <main className="min-h-screen w-full flex flex-col py-12">
        <section className="Container w-full h-full bg-center bg-cover p-8 rounded-2xl relative my-10" style={{backgroundImage: `url(https://image.tmdb.org/t/p/w500${details.backdrop_path || details.poster_path})`}}>

          <div className=" absolute inset-0 bg-gray-900/85 z-10 rounded-2xl"></div>
          <div className=" mx-auto flex flex-col md:flex-row justify-center items-center gap-8 h-full z-30">
                ...
                <div className="flex justify-start items-start gap-12 font-light mb-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <p className="flex flex-col ">
                          <span className="text-gray-300 text-lg">Lançamento:</span>
                    ...
                    <div className="flex flex-col gap-4">
                        <p className="flex flex-col ">
                          <span className="text-gray-300 text-lg">Titulo:</span>
                          ...
                          <span className=" text-gray-400 text-sm">
                            ...
                            {Array.isArray(details.spoken_languages) && (
                              details.spoken_languages.map((language)=>{
                                return(
                                  <span key={language.id} className="ml-1">{language.name}</span>
                                )
                              }))}
